...
<head>
    ...
    <%--<script type='text/javascript' src='http://192.168.0.125:9002/transJs/t.q.d.min.js'></script>--%>
    <%--<script type='text/javascript' src='http://192.168.0.125:9002/transJs/t.q.z.min.js'></script>--%>

    <%--<script type='text/javascript' src='/transJs/jquery-1.10.2.min.js'></script>--%>
    <%--<script type='text/javascript' src='/transJs/m.q.d.min.c2725c10.js'></script>--%>
    <%--<script type='text/javascript' src='/transJs/q.b.a.min.js'></script>--%>
    <%--<script type='text/javascript' src='/transJs/s.d.b.min.js'></script>--%>
    <%--<script type='text/javascript' src='/transJs/t.q.d.min.js'></script>--%>
    <%--<script type='text/javascript' src='/transJs/t.q.z.min.js'></script>--%>
